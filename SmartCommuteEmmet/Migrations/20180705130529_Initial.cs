        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BreakfastCity = table.Column<string>(maxLength: 100, nullable: false),
                    BreakfastDescription = table.Column<string>(maxLength: 100, nullable: true),
                    BreakfastLink = table.Column<string>(nullable: true),
                    BreakfastName = table.Column<string>(maxLength: 50, nullable: false),
                    BreakfastStreet = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BusinessCity = table.Column<string>(maxLength: 100, nullable: true),
                    BusinessDescription = table.Column<string>(maxLength: 100, nullable: true),
                    BusinessName = table.Column<string>(maxLength: 100, nullable: false),
                    BusinessStreet = table.Column<string>(maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "CarouselSponsorImage",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CarouselImagePath = table.Column<string>(nullable: true),
                    DateUploaded = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarouselSponsorImage", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommuteTypeDescription = table.Column<string>(maxLength: 100, nullable: false),
                    CommuteTypeName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    DocumentDescription = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EndPointDescription = table.Column<string>(maxLength: 200, nullable: true),
                    EndPointLatitude = table.Column<float>(nullable: true),
                    EndPointLongitude = table.Column<float>(nullable: true),
                    EndPointName = table.Column<string>(maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    IsGrandPrize = table.Column<bool>(nullable: false),
                    RequiredCommutes = table.Column<int>(nullable: false),
                    RequiredMiles = table.Column<int>(nullable: false),
                    RewardDescription = table.Column<string>(maxLength: 200, nullable: false),
                    RewardName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    SponsorDescription = table.Column<string>(maxLength: 200, nullable: true),
                    SponsorImagePath = table.Column<string>(nullable: true),
                    SponsorLink = table.Column<string>(nullable: false),
                    SponsorName = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    StartPointDescription = table.Column<string>(maxLength: 150, nullable: true),
                    StartPointLatitude = table.Column<float>(nullable: true),
                    StartPointLongitude = table.Column<float>(nullable: true),
                    StartPointName = table.Column<string>(maxLength: 100, nullable: false),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EndPointCustom = table.Column<string>(maxLength: 50, nullable: true),
                    EndPointId = table.Column<int>(nullable: false),
                    StartPointCustom = table.Column<string>(maxLength: 50, nullable: true),
