...
namespace SmartCommuteEmmet.Controllers
{
    public class CommutesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Commute.Include(c => c.CommuteType).Include(c => c.StartPoint).Include(c => c.User);
        ...
        {
            ViewData["CommuteTypeId"] = new SelectList(_context.Set<CommuteType>(), "Id", "Id");
            ViewData["PointId"] = new SelectList(_context.Set<Point>(), "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,CommuteDistance,CommuteDescription,CommuteSaved,CommuteName,CommuteDate,CommuteTypeId,PointId,UserId")] Commute commute)
        {
            ...
            ViewData["CommuteTypeId"] = new SelectList(_context.Set<CommuteType>(), "Id", "Id", commute.CommuteTypeId);
            ViewData["PointId"] = new SelectList(_context.Set<Point>(), "Id", "Id", commute.PointId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CommuteDistance,CommuteDescription,CommuteSaved,CommuteName,CommuteDate,CommuteTypeId,PointId,UserId")] Commute commute)
        {
            if (id != commute.Id)
            {
                return NotFound();
