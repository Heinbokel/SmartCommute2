...
namespace SmartCommuteEmmet.Models
{
    public class StartPoint
    {
        ...
        [Required][Display(Name ="Start Point Description")][StringLength(maximumLength:50,MinimumLength =2,ErrorMessage ="Start Point description must be between 2 and 50 characters.")]
