...
namespace SmartCommuteEmmet.Models
{
    public class EndPoint
    {
        ...
        [Display(Name ="End Point Description")][StringLength(maximumLength:50,MinimumLength =2,ErrorMessage ="End Point description must be between 2 and 50 characters.")]
